...
// Secure React component for sending OTP via BhashSMS using backend API
export default function SendOtpBhashSMS() {
  ...
  // Generate OTP via backend (which uses BhashSMS securely)
  const generateOtp = async (e) => {
    ...
    try {
      ...
      // Use the existing backend API which securely handles BhashSMS credentials
  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded-2xl shadow-md">
      ...
      <div className="mt-4 text-xs text-gray-500">
        <p>
          <strong>Security:</strong> This component uses the secure backend API
          to send OTPs via BhashSMS.
        </p>
        <p>
